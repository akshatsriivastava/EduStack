...
const apiKey = process.env.NEXT_PUBLIC_GEMINI_API_KEY || 'AIzaSyB5xnXGkPQdgZ2HBr8HfldbkgFJAqL6DdA';
console.log('Initializing Gemini AI with API key:', apiKey ? 'Valid API key present' : 'Missing API key');
...
console.log('Model initialized:', model.modelName);
...
console.log('Course Layout AI chat initialized');
...
console.log('Chapter Content AI chat initialized');

// Add debug wrapper function for sending messages
export const sendMessageWithDebug = async (chatSession, message) => {
  console.log('Sending message to AI:', message);
  try {
    const result = await chatSession.sendMessage(message);
    console.log('AI Response received:', result.response.text());
    return result;
  } catch (error) {
